...
// proxy---> what it will do is, it'll use this as our proxy for every request that we make. Now once you deploy, if you've a custom backend or something similar on a specific domain, you would replace, now this is bettre than going in and replacing this in all our requests
